/**
 * @file encryption.cpp
 * @brief OpenFHE CKKS Encryption Example (Legacy)
 * 
 * MIT License
 ...
 * 
 * @deprecated Legacy implementation; see src/encryption.cpp for current version
 * 
 * @details
 * This file demonstrates a complete CKKS encryption workflow:
 * - Fetch threat data from Flask API via HTTP
 * - Initialize OpenFHE cryptographic context
 * - Generate public/secret key pair with evaluation keys
 * - Encrypt threat severity scores
 * - Compute homomorphic mean (sum then divide)
 * - Decrypt and display result
 * 
 * Note: This is archived code from an earlier project phase.
 * The current implementation in src/encryption.cpp is the maintained version.
 * 
...
/**
 * @brief Callback for HTTP response accumulation (libcurl)
 * 
 * Called repeatedly by curl_easy_perform() to buffer response data
 */
